      ...
      <div className="min-h-screen bg-slate-900 p-4">
        <div className="max-w-lg mx-auto pt-8">
            ...
            <ul className="space-y-2">
              {manifest.learningObjectives.map((obj, i) => (
                <li key={i} className="flex items-start gap-2 text-sm text-slate-300">
                  <Target size={14} className="text-violet-400 mt-0.5 shrink-0" />
                  {obj}
                </li>
              ))}
            </ul>
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-violet-500 hover:bg-violet-600 text-white font-semibold text-lg transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="max-w-lg mx-auto pt-8">
          ...
          <div className="bg-slate-800 rounded-xl p-4 mb-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-sm font-semibold text-violet-400">Career Insight</h2>
            </div>
          ...
          <button
            onClick={onExit}
            aria-label="Back to catalog"
            className="w-full py-3 rounded-xl bg-violet-500 hover:bg-violet-600 text-white font-semibold transition-colors"
          >
            Back to Catalog
          </button>
        </div>
      ...
      <div className="sticky top-0 z-10 bg-slate-900/95 backdrop-blur border-b border-slate-800 px-4 py-3">
        <div className="max-w-lg mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Score */}
            <span className="text-sm font-bold text-violet-400">{score}</span>
            {/* Hint button */}
        ...
        <div className="sticky bottom-0 z-10 bg-slate-900/95 backdrop-blur border-t border-slate-800 px-4 py-3">
          <div className="max-w-lg mx-auto">
            <button
              ...
              className="w-full py-3 rounded-xl bg-violet-500 hover:bg-violet-600 text-white font-semibold transition-colors flex items-center justify-center gap-2"
            >

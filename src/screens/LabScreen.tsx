    ...
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate("/")}
            className="px-4 py-2 rounded-xl bg-violet-500 text-white font-medium"
          >
            Back to Home
          </button>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="flex gap-3 justify-center">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-violet-500 text-white font-medium text-sm min-h-[44px]"
            >
              View Founders Pack
            </button>
            <button
    ...
    if (!recommendation) {
      return (
        <div className="bg-slate-800 rounded-xl p-4 text-center">
          <PartyPopper size={24} className="text-violet-400 mx-auto mb-2" />
          ...
          <button
            onClick={() => navigate("/")}
            className="px-4 py-2 rounded-lg bg-violet-500 text-white text-sm font-medium min-h-[44px]"
          >
            Browse All Labs
          </button>
        </div>
    ...
    return (
      <div className="bg-slate-800 rounded-xl p-4">
        ...
        {isRecPremium ? (
          <button
            onClick={() => navigate("/upgrade")}
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-700 text-violet-300 text-sm font-medium min-h-[44px]"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-violet-500 text-white text-sm font-medium min-h-[44px]"
          >

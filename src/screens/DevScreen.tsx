// ============================================================
// CloudForge Dev Preview Screen — /dev
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 p-4 pb-24">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-lg font-bold text-white">CloudForge Dev Preview</h1>
            <p className="text-xs text-slate-400">{labCatalog.length} manifests loaded</p>
          </div>
          <Link to="/" className="text-xs text-violet-400 hover:underline">
            Home
          </Link>
        </div>
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1 text-[10px] font-mono">
                    ...
                    <span className="px-1.5 py-0.5 rounded bg-slate-800 text-violet-300">
                      {lab.rendererType}
                    </span>
                    <span
                ...
                <Link
                  to={`/lab/${lab.id}`}
                  className="shrink-0 px-3 py-1.5 rounded bg-violet-500 text-white text-xs font-semibold hover:bg-violet-600 transition-colors"
                >
                  Play
                </Link>
              </div>

        ...
        <div className="max-w-lg mx-auto pt-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-violet-500/20 flex items-center justify-center">
              <Cloud className="text-violet-400" size={22} />
            </div>
            <div>
              ...
              <div className="bg-slate-800 rounded-xl p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-violet-500 text-white text-xs font-medium min-h-[36px] active:bg-violet-600 transition-colors"
                  >
          ...
          {allFreeComplete && !isPremium && (
            <Link
              to="/upgrade"
              className="block bg-violet-500/10 border border-violet-500/30 rounded-xl p-4 mb-6 active:bg-violet-500/20 transition-colors"
            >
              <p className="text-sm text-violet-200 text-center">
                Ready for more? Unlock advanced labs with CloudForge
                Premium.
              </p>
            </Link>
          )}
